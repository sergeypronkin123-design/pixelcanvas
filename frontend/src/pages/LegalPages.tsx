      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-16">
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
          ...
          <div className="prose prose-invert max-w-none space-y-4 text-canvas-text text-sm leading-relaxed">
            ...
            <p>Настоящая публичная оферта (далее — «Оферта») является официальным предложением самозанятого Пронкина Сергея (ИНН: 250202459700), далее именуемого «Продавец», адресованным любому физическому лицу, далее именуемому «Покупатель», заключить договор купли-продажи цифровых товаров на условиях, изложенных ниже.</p>
